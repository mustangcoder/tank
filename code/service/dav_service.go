...
func (this *DavService) PropstatsFromXmlNames(user *model.User, matter *model.Matter, xmlNames []xml.Name) []dav.Propstat {
...
func (this *DavService) Propstats(user *model.User, matter *model.Matter, propfind *dav.Propfind) []dav.Propstat {
...
//list the directory.
func (this *DavService) HandlePropfind(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
	...
	if depth == 0 {
		...
		matters = this.matterDao.FindByPuuidAndUserUuidAndDeleted(matter.Uuid, user.Uuid, constant.FALSE, nil)
...
//handle download
func (this *DavService) HandleGetHeadPost(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
...
//upload a file
func (this *DavService) HandlePut(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
...
//delete file
func (this *DavService) HandleDelete(w http.ResponseWriter, r *http.Request, user *model.User, subPath string) {
...
//crate a directory
func (this *DavService) HandleMkcol(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
	...
	dbMatter := this.matterDao.FindByUserUuidAndPuuidAndDirAndName(user.Uuid, dirMatter.Uuid, constant.TRUE, thisDirName)
	if dbMatter != nil {
	...
	fileMatter := this.matterDao.FindByUserUuidAndPuuidAndDirAndName(user.Uuid, dirMatter.Uuid, constant.FALSE, thisDirName)
	if fileMatter != nil {
...
//cors options
func (this *DavService) HandleOptions(w http.ResponseWriter, r *http.Request, user *model.User, subPath string) {
...
func (this *DavService) prepareMoveCopy(
	...
	user *model.User, subPath string) (
	...
	if srcMatter.Uuid == constant.MATTER_ROOT {
...
//move or rename.
func (this *DavService) HandleMove(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
...
//copy file/directory
func (this *DavService) HandleCopy(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
...
func (this *DavService) HandleDav(writer http.ResponseWriter, request *http.Request, user *model.User, subPath string) {
